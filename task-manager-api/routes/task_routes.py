...
task_bp.add_url_rule('/tasks', 'create_task', require_auth(task_controller.create_task), methods=['POST'])
task_bp.add_url_rule('/tasks/<int:task_id>', 'update_task', require_auth(task_controller.update_task), methods=['PUT'])
task_bp.add_url_rule('/tasks/<int:task_id>', 'delete_task', require_auth(task_controller.delete_task), methods=['DELETE'])
