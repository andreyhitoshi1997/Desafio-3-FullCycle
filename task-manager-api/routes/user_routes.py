...
user_bp.add_url_rule('/users/<int:user_id>', 'update_user', require_auth(user_controller.update_user), methods=['PUT'])
user_bp.add_url_rule('/users/<int:user_id>', 'delete_user', require_auth(user_controller.delete_user), methods=['DELETE'])
